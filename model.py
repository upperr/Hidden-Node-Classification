...
class DGVAE(Model):
    ...
    def sample(self, nodes, degrees, batch_size = None):
        ...
        for k in range(self.num_encoder_layers):
            ...
            support_size *= self.num_neighbors[t]#layer_infos[t].num_samples
            support_sizes.append(support_size)
            #sampler = layer_infos[t].neigh_sampler
            neighbors = self.uniform_neighbor_sampler((samples[k], self.num_neighbors[t]))#sampler((samples[k], layer_infos[t].num_samples))
